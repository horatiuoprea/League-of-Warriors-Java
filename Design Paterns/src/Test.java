...
public class Test {
    public static void main(String[] args) {
        ...
        Visitor v = new ScoreVisitor(examScores, partialScores, catalog);

        v.visit((Teacher) teacher);
        System.out.println("\nActualizare teacher: " + catalog);
